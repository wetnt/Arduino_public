...
void G5_Show() {
  //------------------------------------------------
  lg(); lg(F("-----------------------------")); lg();
  lg(F("cf10 = ")); lg(g.cf10); lg(F(" ug/m3")); lg(F(" pm10 = ")); lg(g.pm10); lg(F(" ug/m3")); lg();
  lg(F("cf25 = ")); lg(g.cf25); lg(F(" ug/m3")); lg(F(" pm25 = ")); lg(g.pm25); lg(F(" ug/m3")); lg();
  lg(F("cf1X = ")); lg(g.cf1X); lg(F(" ug/m3")); lg(F(" pm1X = ")); lg(g.pm1X); lg(F(" ug/m3")); lg();
  //------------------------------------------------
  lg();
  lg(F("um03 = ")); lg(g.um03); lg();
  lg(F("um05 = ")); lg(g.um05); lg();
  lg(F("um10 = ")); lg(g.um10); lg();
  lg(F("um25 = ")); lg(g.um25); lg();
  lg(F("um50 = ")); lg(g.um50); lg();
  lg(F("um1X = ")); lg(g.um1X); lg();
  //------------------------------------------------
  lg();
