...
void drawLogo(uint8_t d) {
  u8g.setFont(u8g_font_gdr25r);  u8g.drawStr(0 + d, 30 + d, "U");
  u8g.setFont(u8g_font_gdr30n);  u8g.drawStr90(23 + d, 10 + d, "8");
  u8g.setFont(u8g_font_gdr25r);  u8g.drawStr(53 + d, 30 + d, "g");
...
void drawURL(void) {
  u8g.setFont(u8g_font_4x6);
  if ( u8g.getHeight() < 59 ) {
    u8g.drawStr(53, 9, "www.tanglocker.com");
