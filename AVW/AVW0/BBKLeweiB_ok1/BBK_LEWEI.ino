...
void LEWEI_Loop()
{
  ...
  b = BBK_LeWei_Client_Append("GL", 20);
  b = BBK_LeWei_Client_Append("DL", 1.5f);
  b = BBK_LeWei_Client_Append("DY", 200);
  //b = BBK_LeWei_Client_Append("YDL", 50.5f);
  b = BBK_LeWei_Client_Append("GLYS", 0.8f);
