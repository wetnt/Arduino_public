...
//----------------------------------------------------
dht DHT11;
//#define DHT11PIN 3 //dht11????
uint8_t DHT11PIN = 3;
//----------------------------------------------------
#define USERKEY          "4a7c908d0de946de96e041dd84834154" // replace your key here
#define LW_GATEWAY       "01"
//----------------------------------------------------  
LeWeiClient *lwc;
//LeweiTcpClient *lwc;
//----------------------------------------------------
byte my_mac[] = {0x74,0x69,0x69,0x2D,0x30,0x31};
//----------------------------------------------------
...
void setup() {
  ...
  //lwc = new LeweiTcpClient(USERKEY, LW_GATEWAY,my_mac,mylwip,my_dns,mylwgw,subnet);
