...
//boolean wfs_cmd_backAB(String comStr, String strOK, String strNO, long timeout, String a, String b) { //
//  //-------------------------------------------------------
//  boolean save = false; char c; unsigned long start = millis(); wifiBack = "";
//  ck1.init(strOK);
//  ck2.init(strNO);
...
//      if (logKey) lg(c);
//      //-----------------------------------
//      if (ck3.check(c)) save = true;
//      if (save) wifiBack += c;
//      if (ck4.check(c)) save = false;
//      //-----------------------------------
//      if (ck1.check(c)) return true;
//      if (ck2.check(c)) return false;
//      if (ck5.check(c)) return false;
...
//boolean wfs_cmd_back_AB(String comStr, String strOK, String strNO, long timeout, char a, char b) { //
//  //-------------------------------------------------------
//  boolean save = false; char c; unsigned long start = millis(); wifiBack = "";
//  //------------------------------------------------------
//  wfs_serial_clear(); wfs.println(comStr);
...
//    if ( strNO.length() > 0 && wifiBack.indexOf(strNO) != -1 ) return false;
//    if (                  wifiBack.indexOf(G(AT_Errs)) != -1 ) return false;
//    if (                  wifiBack.indexOf(G(AT_Busy)) != -1 ) smartDelay(1);
//    smartDelay(1);
//    //-------------------------------------------------------
//  }
//  //-------------------------------------------------------
