...
void rc_cmd_feed(char c) {
  ...
  //---------------------------------------------------------
  else if (rc_idx == 17) Pp = getK(rc_cmd[14], rc_cmd[15], rc_cmd[16], rc_cmd[17]);
  else if (rc_idx == 22) Pi = getK(rc_cmd[19], rc_cmd[20], rc_cmd[21], rc_cmd[22]);
  else if (rc_idx == 27) Pd = getK(rc_cmd[24], rc_cmd[25], rc_cmd[26], rc_cmd[27]);
  //---------------------------------------------------------
