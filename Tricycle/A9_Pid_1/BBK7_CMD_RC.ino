//-------------------------------------
//0123456789012 3 456 789 012 34567890
//$FF7F7F7F00FF P 085 020 000 *
//-------------------------------------
...
void rc_cmd_feed(char c) {
  ...
  //---------------------------------------------------------
  else if (rc_idx == 16) cmd_6thss = getK(rc_cmd[14], rc_cmd[15], rc_cmd[16]);
  else if (rc_idx == 19) cmd_6thss = getK(rc_cmd[17], rc_cmd[18], rc_cmd[19]);
  else if (rc_idx == 22) cmd_6thss = getK(rc_cmd[20], rc_cmd[21], rc_cmd[22]);
  //---------------------------------------------------------
  if (rc_idx == 23) rc_pid_run();
  //---------------------------------------------------------
}
void rc_cmd_clear() {
