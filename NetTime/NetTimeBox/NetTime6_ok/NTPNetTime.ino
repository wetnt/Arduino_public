...
//-------------------------------------------------------------
int ntpYearss, ntpMonths, ntpDatess, ntpDayweek;
int ntpHourss, ntpMinute, ntpSecond;
...
{
  //-------------------------------------------------------------
  snprintf(dateStr,  8, "NET_Date: %4d-%02d-%02d",  ntpYearss,ntpMonths,ntpDatess);
  snprintf(timeStr, 17, "NET_Time: %02d:%02d:%02d", ntpHourss,ntpMinute,ntpSecond);
