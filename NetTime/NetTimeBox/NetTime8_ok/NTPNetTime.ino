...
unsigned long NtpTimerKey = 6*1000;//60s
unsigned long NtpShowTimer = 0;
unsigned long NtpShowTimerKey = 1000;//1s
//-------------------------------------------------------------
...
{
  //-------------------------------------------------------------------
  if( millis() - NtpTimer < NtpTimerKey ) return;
  NtpTimer = millis();
  //-------------------------------------------------------------
...
void NTPTime_Setting()
{
  ...
  //-------------------------------------------------------------
  TimeSets(ntpHourss,ntpMinute,ntpSecond);
  //-------------------------------------------------------------
}
...
{
  //-------------------------------------------------------------------
  if( millis() - NtpShowTimer < NtpShowTimerKey ) return;
  NtpShowTimer = millis();
  //-------------------------------------------------------------
