...
//---------------------------------------------------------------------------------
//int BMP_Color_Key = 1,  int BMP_Time_Key = 1000;
int STR_Color_Key = 1;
uint8_t bmp1[10] = {0x00, 0x66, 0xFF, 0xFF, 0xFF, 0x7E, 0x3C, 0x18, 1, 5};
uint8_t bmp2[10] = {0x00, 0x24, 0x7E, 0x7E, 0x3C, 0x18, 0x00, 0x00, 2, 5};
uint8_t bmp3[10] = {0x00, 0x66, 0xFF, 0xFF, 0xFF, 0x7E, 0x3C, 0x18, 1, 5};
uint8_t bmp4[10] = {0x00, 0x24, 0x7E, 0x7E, 0x3C, 0x18, 0x00, 0x00, 2, 5};
uint8_t bmp5[10] = {0x00, 0x66, 0xFF, 0xFF, 0xFF, 0x7E, 0x3C, 0x18, 1, 5};
//uint8_t bmp6[10] = {0x00, 0x24, 0x7E, 0x7E, 0x3C, 0x18, 0x00, 0x00, 2, 5};
...
void RGB8X8_loop() {
  ...
  RGB8X8_text(rgb_string, STR_Color_Key, 70);
  //RGB8X8_bmp(bmp6);
  //---------------------------------------------------------------------------------
  //matrix.clear(); matrix.writeDisplay(); smartDelay(200);
  //---------------------------------------------------------------------------------
}
char output[9];
