...
String ax1, ax2, ax3, ax4, ax5;//, ax6;
void WeatherHttpExp() {
  //------------------------------------------
  HttpBufferShow(); lg();
  lg();
  ...
  //ax6 = GetStringAB(bufferBack, "BMP6:", ";"); lg("ax6="); lg(ax6); lg();

  String b1 = GetStringAB(bufferBack, "STRM:", ";"); lg("b1="); lg(b1); lg();
  String b2 = GetStringAB(bufferBack, "STRC:", ";"); lg("b2="); lg(b2); lg();
  //--------------------------------------------
  for (int i = 0; i < 10; i++) {
    ...
    //bmp6[i] = getV(ax6[i * 2], ax6[i * 2 + 1]);
  }
  //--------------------------------------------
  rgb_string = b1;//"I love You,MaYuan!";
  STR_Color_Key = getV(b2[0], b2[1]);
  if (STR_Color_Key <= 0 || STR_Color_Key > 3) STR_Color_Key = 1;
  //--------------------------------------------
}
