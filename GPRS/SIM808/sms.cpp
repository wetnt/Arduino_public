...
//Serial.println("3rd line");
          break;
     case SMS_ALL:
          gsm.SimpleWriteln(F("AT+CMGL=\"ALL\""));
//Serial.println("4th line");
          break;
     }
...
//Serial.println("6th line");
     switch (status) {
     case RX_TMOUT_ERR:
          // response was not received in specific time
          ret_val = -2;
//Serial.println("7th line");
          break;
