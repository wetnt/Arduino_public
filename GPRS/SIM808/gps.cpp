...
char GPSGSM::attachGPS()
{
     if(AT_RESP_ERR_DIF_RESP == gsm.SendATCmdWaitResp("AT+CGNSPWR=1", 500, 100, "OK", 5))
          return 0;
     if(AT_RESP_ERR_DIF_RESP == gsm.SendATCmdWaitResp("AT+CGNSSEQ=GGA", 500, 100, "OK", 5))
          return 0;
     return 1;
}
...
char GPSGSM::getPar(char *lat, char *lon, char *alt, char *sat)
{
     char ret_val=0;
     char *p_char;
     char *p_char1;
