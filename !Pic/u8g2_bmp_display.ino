...
U8G2_SSD1306_128X64_NONAME_1_3W_SW_SPI u8g2(U8G2_R0, /* CLK= */ 13 , /* MO= */ 11 ,/* CS= */ 6);
...
void setup() {
  ...
  u8g2.begin(/*Select=*/ 7, /*Right/Next=*/ 3, /*Left/Prev=*/ 2, /*Up=*/ A0, /*Down=*/ 4, /*Home/Cancel=*/ 8); // Arduboy 10 (Production)
}
