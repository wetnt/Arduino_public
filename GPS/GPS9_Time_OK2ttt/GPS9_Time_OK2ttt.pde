...
//unsigned char fseg[]={192,249,164,176,153,146,130,248,128,144,64191};

//unsigned char fseg[]={192,249,164,176,153,146,130,248,128,144,64,121,36,48,25,18,2,120,0,16,191};
unsigned char fseg[]={ 
...
void loopt() 
{
  ...
  {    
    ...
    shiftOut(dataPin, clockPin, MSBFIRST, segbit[0]);
    shiftOut(dataPin, clockPin, MSBFIRST, fseg[j]);
