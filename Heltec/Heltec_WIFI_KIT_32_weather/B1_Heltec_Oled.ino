...
void oled_setup() {
  ...
  //--------------------------------------------------
  oled.clear(); drawFontFaceDemo(); oled.display(); delay(3000);
  //oled.clear(); drawTextFlowDemo(); oled.display(); delay(3000);
}
...
void drawFontFaceDemo() {
  ...
  oled.setFont(ArialMT_Plain_10); oled.drawString(0, 0, "BOBOKing.COM");
  oled.setFont(ArialMT_Plain_24); oled.drawString(0, 12, "NetWeather");
  oled.setFont(ArialMT_Plain_16); oled.drawString(70, 38, "by XJP");
  oled.display();
}
