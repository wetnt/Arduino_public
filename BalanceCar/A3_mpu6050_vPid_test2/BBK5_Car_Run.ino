//===================================================================
int CarR = 0, CarL = 0;//小车左右轮胎控制值
//===================================================================
Wheel wr, wl;//定义两个轮子
double carSpeedMax = 1.0;//极速
//===================================================================
...
void Car_Init() { //小车初始化
  ...
  //---------------------------------------------------------
  lg(F("Car_Init()..."));
  wr.init(Radius, WheelN, 1, 9, 10, 8); //轮子半径,槽数（一圈）,中断,A,B,EN
  wl.init(Radius, WheelN, 0, 11, 12, 13);
...
void Car_SetVt(int r, int l) {//设置小车左右轮子控制值
  CarR = r; CarL = l;
}
void Car_loop() {//小车运动循环
  Pid_BalanceCar_Loop();
  wr.runs(CarR); wr.speedCalc(loopMS); wl.runs(CarL); wl.speedCalc(loopMS);
}
//===================================================================
